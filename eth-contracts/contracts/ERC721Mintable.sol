...
contract Ownable {
    ...
    modifier onlyOwner()
    {
        require(msg.sender == _owner, "Caller isn't owner");
        _;
    }
    ...
    {
        require(newOwner != address(0), "The addr isn't a ethereum addr");
        _owner = newOwner;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != tokenOwner, "Caller cannot be the owner of the tokenId");
...
contract ERC721MintableComplete is ERC721Metadata("House Token", "HT", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/")
{
